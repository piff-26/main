        ...
        @if ($currentStep == 1)
            <div class="flex flex-col md:flex-row gap-8">
                <div class="w-full md:w-3/5 space-y-6">
                    ...
                    {{-- Removed TICKET OWNERS section for online pass --}}
                        ...
                        <div class="space-y-4 mb-6">
                            @foreach ($transaction->transactionItems as $item)
                                <div class="flex justify-between items-start">
                                    <div>
                                        <p class="text-white font-semibold">{{ $item->onlineTicket->name }}</p>
                                        <p class="text-slate-400 text-sm">{{ $item->quantity }}x Online Pass</p>
                                    </div>
        ...
        @elseif ($currentStep == 3)
            <div class="flex flex-col items-center justify-center py-10 text-center">
                ...
                <div class="bg-slate-800/50 border border-slate-700 p-6 rounded-2xl w-full max-w-md mb-8">
                    ...
                    <div class="flex justify-between mb-2">
                        <span class="text-slate-400">Online Ticket Quantity</span>
