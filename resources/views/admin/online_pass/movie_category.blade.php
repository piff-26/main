        ...
        <table class="w-full text-left border-collapse">
            <thead>
                <tr class="bg-gray-50 border-b border-gray-100">
                    ...
                    <!-- <th class="py-3 px-4 font-semibold text-gray-600 text-sm">Slug</th> -->
                ...
                <tr class="border-b border-gray-50 hover:bg-gray-50/50">
                    ...
                    <td class="py-3 px-4">
                        <div class="flex items-center gap-2">
                            ...
                            <form action="{{ route('admin.movie_category.destroy', $category->id) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this category?');">
                                @csrf
                                @method('DELETE')
...
<div id="addModal" class="fixed inset-0 bg-black/50 hidden z-50 flex items-center justify-center">
    <div class="bg-white rounded-xl shadow-xl max-w-md w-full mx-4">
        <div class="p-6">
            ...
            <form action="{{ route('admin.movie_category.store') }}" method="POST">
                @csrf
                <div class="mb-4">
