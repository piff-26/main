...
@section('content')
    <div class="bg-gray-50 min-h-screen py-36">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center">
                <button id="pay-button"
                    class="w-full sm:w-auto inline-flex justify-center items-center px-8 py-4 border border-transparent rounded-lg shadow-md text-lg font-bold text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all transform hover:scale-105">
        ...
        document.getElementById('pay-button').onclick = function() {
            ...
            snap.pay('{{ $snapToken }}', {
                ...
                onSuccess: function(result) {
                    ...
                    window.location.href = "{{ route('user.ticket') }}"; // Sesuaikan nama route history
                },
                ...
                onClose: function() {
                    alert(
                        'Anda menutup popup sebelum menyelesaikan pembayaran. Segera bayar sebelum waktu habis!'
                        );
                }
            });
        };
