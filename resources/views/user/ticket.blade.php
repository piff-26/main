            ...
            @else
                <div class="grid grid-cols-1 gap-y-10 sm:grid-cols-2 gap-x-6 lg:grid-cols-3 xl:gap-x-8">
                    ...
                    @foreach ($events as $event)
                        <div
                            class="group relative bg-white border border-gray-200 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden flex flex-col">
                            ...
                            <div class="p-6 flex-1 flex flex-col justify-between">
                                ...
                                <div class="mt-4 pt-4 border-t border-gray-100">
                                    <a href="{{ route('checkout.step1', $event->slug) }}"
                                        class="w-full flex justify-center items-center px-4 py-2 border border-transparent rounded-lg shadow-sm text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
                                        Beli Tiket
                                    </a>
                                </div>
                            </div>
