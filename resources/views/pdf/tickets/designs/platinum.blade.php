<div style="border: 2px dashed #333; padding: 30px; border-radius: 10px; margin-top: 50px;">
    ...
    <div class="text-center">
        <h1 style="text-transform: uppercase; letter-spacing: 3px; color: #b78727;">
    ...
    <table class="w-100">
        <tr>
            ...
            <td style="width: 40%; text-align: center; vertical-align: top;">
                ...
                @php
                    $qrCodeSvg = \SimpleSoftwareIO\QrCode\Facades\QrCode::size(120)->generate(route('api.checkin', $ticket->ticket_code));
